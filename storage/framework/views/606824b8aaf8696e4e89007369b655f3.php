...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app.delete-modal','data' => ['wire:model.live' => 'showModal','titulo' => 'ELIMINAR COTIZACION','body' => 'Estás seguro de eliminar esta cotización?.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showModal','titulo' => 'ELIMINAR COTIZACION','body' => 'Estás seguro de eliminar esta cotización?.']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon2\www\pharmacy\resources\views/livewire/admin/comprobantes/cotizaciones/delete.blade.php ENDPATH**/ ?>