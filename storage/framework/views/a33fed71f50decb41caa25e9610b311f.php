...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['titulo', 'body', 'id']));
...
foreach (array_filter((['titulo', 'body', 'id']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
?>
<div class="m-1.5">
    <div x-data="{ showModal: <?php if ((object) ($attributes->wire('model')) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')->value()); ?>')<?php echo e($attributes->wire('model')->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')); ?>')<?php endif; ?> }" id="<?php echo e($id); ?>">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            <div class="text-lg font-semibold text-slate-800 dark:text-slate-200 uppercase">
                                <?php echo e($titulo); ?></div>
                        </div>

                        <div class="text-sm mb-10">
                            <div class="space-y-2">
                                <p class="text-slate-600 dark:text-slate-300"> <?php echo e($body); ?> </p>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon2\www\pharmacy\resources\views/components/app/delete-modal.blade.php ENDPATH**/ ?>