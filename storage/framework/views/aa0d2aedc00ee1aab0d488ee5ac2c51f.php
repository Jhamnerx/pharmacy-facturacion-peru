                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            <div class="text-lg font-semibold text-slate-800 dark:text-slate-200 uppercase">
                                Cerrar caja chica POS
                            </div>
                        </div>

                        <div class="text-sm mb-10">
                            <div class="space-y-2">
                                <p class="text-slate-600 dark:text-slate-300">¿Está seguro de cerrar la caja?</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap justify-end space-x-2 text-right">
                            ...
                            <button wire:click.prevent="closeCaja()"
...
<?php /**PATH C:\laragon2\www\pharmacy\resources\views/livewire/admin/cajas/close-caja.blade.php ENDPATH**/ ?>