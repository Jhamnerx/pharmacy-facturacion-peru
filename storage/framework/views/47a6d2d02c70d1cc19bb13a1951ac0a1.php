...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['data','withErrorIcon','padding']));
...
foreach (array_filter((['data','withErrorIcon','padding']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = WireUi\Components\Wrapper\TextField::resolve(['data' => $data,'withErrorIcon' => $withErrorIcon,'padding' => $padding] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\laragon2\www\pharmacy\storage\framework\views/38e6354c2efadc3061ca7fb13454f61c.blade.php ENDPATH**/ ?>