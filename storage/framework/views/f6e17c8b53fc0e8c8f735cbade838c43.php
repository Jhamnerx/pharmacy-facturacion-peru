...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['data','name','id','disabled','readonly']));
...
foreach (array_filter((['data','name','id','disabled','readonly']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = WireUi\Components\Wrapper\TextField::resolve(['data' => $data,'name' => $name,'id' => $id,'disabled' => $disabled,'readonly' => $readonly] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\laragon2\www\pharmacy\storage\framework\views/ca6516a00d5b0e0108890f2ce9f35f0f.blade.php ENDPATH**/ ?>