...
<body style="margin: -5mm -5mm;;" class="white-bg">
    <page backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm">
                ...
                <tbody>
                    <tr>
                        <td width="60%" align="left"><strong>Razón Social:</strong>
                            <?php echo e($devolucion->venta->cliente->razon_social); ?></td>
                        <td width="40%" align="left">
                            <strong><?php echo e($devolucion->venta->cliente->tipoDocumento->descripcion); ?>:</strong>
                    ...
                    <tr>
                        <td width="60%" align="left"><strong>Doc. Afectado </strong>

                            <?php echo e($devolucion->venta->serie_correlativo); ?>

                        </td>
                    </tr>
                    <tr>
                        <td width="60%" align="left">
                            <strong>Fecha Emisión: </strong> <?php echo e($devolucion->fecha_emision->format('d/m/Y')); ?>

                        </td>
                        <td width="40%" align="left"><strong>Dirección: </strong>
                            <?php echo e($devolucion->venta->cliente->direccion); ?></td>
                        </td>
                    </tr>
        ...
        <div class="total-letras">
            ...
            <?php echo e($formatter->toInvoice($devolucion->total, 2, $devolucion->divisa == 'PEN' ? 'SOLES' : 'DÓLARES')); ?>
        ...
        <?php if($devolucion->detalle->count() > 10): ?>
...
<?php /**PATH C:\laragon2\www\pharmacy\resources\views/templates/comprobantes/devolucion.blade.php ENDPATH**/ ?>