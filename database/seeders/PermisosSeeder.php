...
class PermisosSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $c_caja_chica = CategoriaPermisos::create(['nombre' => 'Caja chica']);
        ...
        $permisos_caja = [
            ...
            'caja_chica.cambiar_estado' => 'Cambiar estado de caja chica',

        ];


        foreach ($permisos_caja as $name => $description) {
            $c_caja_chica->permisos()->create(['name' => $name, 'description' => $description]);
        }


        $c_devoluciones = CategoriaPermisos::create(['nombre' => 'Devoluciones']);

        $permisos_devoluciones = [
            ...
            'devoluciones.cambiar_estado' => 'Cambiar estado de devoluciones',
        ];

        foreach ($permisos_devoluciones as $name => $description) {
            $c_devoluciones->permisos()->create(['name' => $name, 'description' => $description]);
        }
        ...
        // $c_productos = CategoriaPermisos::find(6);
        // $new_permisos_productos = [
        //     [
        //         'name' => 'productos.aumentar_stock',
        //         'description' => 'Aumentar stock de productos',
        //     ],
        //     [
        //         'name' => 'productos.lotes.ver',
        //         'description' => 'Ver lotes de productos',
        //     ],
        //     [
        //         'name' => 'productos.lotes.editar',
        //         'description' => 'Editar lotes de productos',
        //     ],
        //     [
        //         'name' => 'productos.lotes.eliminar',
        //         'description' => 'Eliminar lotes de productos',
        //     ]
        // ];

        // foreach ($new_permisos_productos as $permiso) {
        //     $c_productos->permisos()->create($permiso);
        // }
