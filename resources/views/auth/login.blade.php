    ...
    <main>
        ...
        <div class="relative flex">
                    ...
                    <div class="max-w-sm mx-auto px-4 py-8">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <button aria-label="Continue with google" role="button"
                                ...
                                <img src="{{ asset('imagenes/icons/google.svg') }}" alt="google">
                            ...
                            <button aria-label="Continue with facebook" role="button"
                                ...
                                <img class="w-5 h-5" src="{{ asset('imagenes/icons/facebook.svg') }}" alt="facebook">
                        ...
                        <div class="pt-5 mt-6 border-t border-slate-200 dark:border-slate-700">
                            <img class=" ml-8 block lg:hidden" src="{{ asset('imagenes/login/auth-decoration2.png') }}"
            ...
            <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                <img class="object-cover object-center w-full h-full" src="{{ asset('imagenes/login/auth-image.png') }}"
                ...
                <img class="absolute top-1/4 left-0 transform -translate-x-1/2 ml-8 hidden lg:block"
                    src="{{ asset('imagenes/login/auth-decoration2.png') }}" width="218" height="224"
                    alt="Authentication decoration" />
            </div>
            {{-- <div class="block md:hidden absolute top-0 bottom-0 -z-10 right-0 md:w-1/2" aria-hidden="true">
                <img class="object-cover object-center bg-no-repeat w-full h-full" src="imagenes/auth-mobile.jpg"
