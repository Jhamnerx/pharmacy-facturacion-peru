...
<body style="margin: -5mm -5mm;;" class="white-bg">
    <page backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm">
                ...
                <tbody>
                    <tr>
                        <td width="60%" align="left"><strong>Razón Social:</strong>
                            {{ $devolucion->venta->cliente->razon_social }}</td>
                        <td width="40%" align="left">
                            <strong>{{ $devolucion->venta->cliente->tipoDocumento->descripcion }}:</strong>
                    ...
                    <tr>
                        <td width="60%" align="left"><strong>Doc. Afectado </strong>
                            ...
                            {{ $devolucion->venta->serie_correlativo }}
                        </td>
                    </tr>
                    <tr>
                        <td width="60%" align="left">
                            <strong>Fecha Emisión: </strong> {{ $devolucion->fecha_emision->format('d/m/Y') }}
                        </td>
                        <td width="40%" align="left"><strong>Dirección: </strong>
                            {{ $devolucion->venta->cliente->direccion }}</td>
                        </td>
                    </tr>
        ...
        <div class="total-letras">
            ...
            {{ $formatter->toInvoice($devolucion->total, 2, $devolucion->divisa == 'PEN' ? 'SOLES' : 'DÓLARES') }}

        </div>

        <br>

        @if ($devolucion->detalle->count() > 10)
