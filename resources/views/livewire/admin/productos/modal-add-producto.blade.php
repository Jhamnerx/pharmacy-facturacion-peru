<x-ventas.form-modal-w-buttons titulo="NUEVO ITEM" wire:model.live="showModal" maxWidth="2xl">
    ...
    @if ($anticipo)
        ...
        <div class="col-span-12 md:col-span-9 md:col-start-2">
            <x-errors only="prepayments.serie_ref|prepayments.correlativo_ref" />
    ...
    @else
        ...
        <div class="col-span-12 md:col-span-7 mt-2">
            ...
            <x-form.select autocomplete="off" :clearable="false" wire:model.live="product_selected_id"
                ...
                ]" option-label="nombre" option-value="id" option-description="option_description"
                :template="[
                    'name' => 'user-option',
                    'config' => ['src' => 'imagen'],
                ]" :always-fetch="true">
    ...
    @else
        ...
        <div class="col-span-12 md:col-start-5 md:col-span-4">
            ...
            <x-form.currency id="valor_unitario" name="valor_unitario" prefix="{{ $divisa == 'PEN' ? 'S/ ' : '$' }}"
                wire:model.blur="selected.valor_unitario" precision="6" />
    ...
    <div class="col-span-12 md:col-start-5 md:col-span-4">
        ...
        @else
            <x-form.currency id="total" name="total" precision="4" placeholer="0.00"
                prefix="{{ $divisa == 'PEN' ? 'S/ ' : '$' }}" wire:model.blur="selected.total" readonly />
        @endif
    </div>
