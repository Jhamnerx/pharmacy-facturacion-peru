<x-form.modal.card title="Editar Medicamento" wire:model.live="showModal" align="center" persistent width="6xl">
            ...
            <div x-show="activeTab === 'additional-info'">
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 md:col-start-3 md:col-end-10" wire:ignore>
                        <input name="imagen-upload-edit" id="imagen-upload-edit" type="file"
                            class="imagen-upload-edit" accept="image/*">
                    </div>
                </div>
            </div>
        </div>
