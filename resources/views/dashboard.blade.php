...
@section('contenido')
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full |" :class="{ 'sidebar-expanded': sidebarExpanded }" x-data="{ page: 'dashboard-inicio', sidebarOpen: false, sidebarExpanded: localStorage.getItem('sidebar-expanded') == 'false' }"
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <!-- Left: Avatars -->
            @livewire('admin.dashboard.avatars')
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                @livewire('admin.dashboard.fecha-cards')
        ...
        <div class="grid grid-cols-12 gap-6">
            @livewire('admin.dashboard.cards.facturas')
            @livewire('admin.dashboard.cards.boletas')
            @livewire('admin.dashboard.cards.notas-venta')
            @livewire('admin.dashboard.cards.total')
