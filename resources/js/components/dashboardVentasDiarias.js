...
const dashboardCard04 = () => {
    const ctx = document.getElementById("ventas-diarias-card");
    if (!ctx) return;
    ...
    fetch(`/api/card-ventas-diarias/${localId}`)
        .then((a) => {
            return a.json();
        })
        .then((result) => {
            const dataset = result.data.Ventas.totales;
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        htmlLegend: {
                            ...
                            containerID: "ventas-diarias-card-legend",
                        },
                        tooltip: {
                            callbacks: {
