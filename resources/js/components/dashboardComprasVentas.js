...
const dashboardCard04 = () => {
    const ctx = document.getElementById("compras-ventas-card");
    if (!ctx) return;
    ...
    fetch("/api/card-ventas-compras")
        ...
        .then((result) => {
            const dataset1 = result.data.Compras.totales;
            const dataset2 = result.data.Ventas.totales;
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        htmlLegend: {
                            ...
                            containerID: "compras-ventas-card-legend",
                        },
                        tooltip: {
                            callbacks: {
